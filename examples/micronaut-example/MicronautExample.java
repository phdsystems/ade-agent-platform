...
/**
 * Example: Using ade-agent-platform-micronaut with dependency injection.
 *
 * <p>This demonstrates Micronaut integration with compile-time DI.
 * All core components are auto-configured as Micronaut beans.
 *
 * <p><b>Dependencies:</b>
 * <pre>
 * &lt;dependency&gt;
...
public class MicronautExample {
    ...
    void onStartup(StartupEvent event) {
        log.info("=== Micronaut Example ===");
        log.info("Using ade-agent-platform-micronaut with compile-time DI\n");
        ...
        try {
            ...
            log.info("\n✅ Success! Platform works with Micronaut compile-time DI.");
