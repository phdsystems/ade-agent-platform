...
class SimpleToolProviderTest {
    ...
    void shouldInvokeEchoTool() {
        ...
        ToolInvocation invocation =
                new ToolInvocation("echo", Map.of("text", "Hello, World!"), Map.of());
    ...
    void shouldReturnErrorForUnknownTool() {
        // Given
        ToolInvocation invocation = new ToolInvocation("unknown_tool", Map.of(), Map.of());
    ...
    void shouldReturnErrorForToolWithoutImplementation() {
        // Given
        Tool tool = new Tool("no_impl", "Tool without implementation", Map.of(), "test");
        provider.registerTool(tool).block();

        ToolInvocation invocation = new ToolInvocation("no_impl", Map.of(), Map.of());
    ...
    void shouldReturnEmptyForNonExistentTool() {
        // When & Then
        StepVerifier.create(provider.getTool("non_existent")).verifyComplete();
    }
    ...
    void shouldUnregisterTool() {
        // Given
        Tool tool = new Tool("temp_tool", "Temporary tool", Map.of(), "test");
        provider.registerTool(tool).block();
    ...
    void shouldInvokeCustomToolWithImplementation() {
        ...
        ToolInvocation invocation =
                new ToolInvocation("reverse", Map.of("text", "hello"), Map.of());
    ...
    void shouldCaptureExecutionTime() {
        // Given
        ToolInvocation invocation = new ToolInvocation("echo", Map.of("text", "test"), Map.of());
    ...
    void shouldHandleExceptionInToolExecution() {
        // Given
        Tool tool = new Tool("error_tool", "A tool that throws an exception", Map.of(), "test");
        ...
        ToolInvocation invocation = new ToolInvocation("error_tool", Map.of(), Map.of());
